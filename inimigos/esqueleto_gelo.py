...
class EsqueletoGelo(Inimigo):
    def __init__(self, x, y, largura, altura, nome="Esqueleto de Gelo", hp=150, velocidade=1.2, dano=20):
        ...
        # Sprites
        self.sprites_andando_frente = image.load(resource_path('./assets/Enemies/esqueleto_frente_run.png')).convert_alpha()
        self.sprites_andando_costas = image.load(resource_path('./assets/Enemies/esqueleto_frente_costas.png')).convert_alpha()
        self.sprites_andando_lado = image.load(resource_path('./assets/Enemies/esqueleto_run.png')).convert_alpha()
        self.sprites_ataque = image.load(resource_path('./assets/Enemies/esqueleto_ataque.png')).convert_alpha()
    ...
    def atualizar(self, player_pos, tela, matriz_colisao, offset_mapa, player):
        ...
        if distancia < 100:
            ...
            if now - self.tempo_ultimo_ataque > self.cooldown_ataque:
                ...
                player.aplicar_lentidao(0.5,4000) #multiplicador da velocidade e tempo em ms
