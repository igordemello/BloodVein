...
class Massa(Inimigo):
    def __init__(self, x, y, largura, altura, nome="Massa de Olhos", hp=100, velocidade=1.5, dano=10):
        ...
        self.total_frames = 4
        self.usar_indices = list(range(0, self.total_frames, 1))
        ...
        self.attack_spritesheet = image.load(resource_path('assets/Enemies/Massa_De_Olhos-ataque.png')).convert_alpha()
        self.attack_frames = []
        self.attack_total_frames = 4
